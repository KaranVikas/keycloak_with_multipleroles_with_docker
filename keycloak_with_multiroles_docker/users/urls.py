...
from .views import TokenValidationView, KeycloakConfigView, KeycloakSyncUserView
...
urlpatterns = [
  ...
  path('auth/keycloak/sync/', KeycloakSyncUserView.as_view(), name='keycloak_sync_user'),
  #   Existing endpoints
